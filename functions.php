...
function templateq_enqueue()
{
	...
	// Pull PJAX
	wp_enqueue_script('pjax', 'https://cdn.jsdelivr.net/npm/pjax@latest/pjax.min.js', array(), 'latest');
	wp_enqueue_script('templateq_pjax', get_template_directory_uri() . '/js/pjax.js', array('pjax'), '0.0.1');
}
