...
add_action('wp_enqueue_scripts', function() {
	...
	// Pull custom JS
	wp_enqueue_script('templateq_codeview', get_template_directory_uri() . '/js/codeview.js', array('jquery'), '0.0.1', true);
	wp_enqueue_script('templateq_submenu', get_template_directory_uri() . '/js/submenu.js', array('jquery'), '0.0.1', true);
	wp_enqueue_script('templateq_tabview', get_template_directory_uri() . '/js/tabview.js', array('jquery'), '0.0.1', true);
	...
	wp_enqueue_script('templateq_toggleFeatures', get_template_directory_uri() . '/js/toggleFeatures.js', array('cookies'), '0.0.1', true);
