...
add_action('admin_enqueue_scripts', function() {
	...
	wp_enqueue_script('templateq_backend', get_template_directory_uri() . '/backend/script.js', array(), $QNIPSEL_VERSION);
});
...
add_action('wp_enqueue_scripts', function() {
	...
	// Pull custom CSS
	wp_enqueue_style('templateq_css', get_template_directory_uri() . '/dist/css/main.min.css', array(), $QNIPSEL_VERSION);
	...
	// Pull custom JS
	wp_enqueue_script('templateq_codeview', get_template_directory_uri() . '/js/codeview.js', array('jquery'), $QNIPSEL_VERSION, true);
	wp_enqueue_script('templateq_submenu', get_template_directory_uri() . '/js/submenu.js', array('jquery'), $QNIPSEL_VERSION, true);
	wp_enqueue_script('templateq_tabview', get_template_directory_uri() . '/js/tabview.js', array('jquery'), $QNIPSEL_VERSION, true);
	...
	wp_enqueue_script('templateq_toggleFeatures', get_template_directory_uri() . '/js/toggleFeatures.js', array('cookies'), $QNIPSEL_VERSION, true);
